  ...
  create or replace table `sales-demo-project-314714`.`dbt_cberger`.`fct_order_items`
...
with order_item as (
    ...
    select * from `sales-demo-project-314714`.`dbt_cberger`.`order_items`

),
part_supplier as (
    
    select * from `sales-demo-project-314714`.`dbt_cberger`.`part_suppliers`
